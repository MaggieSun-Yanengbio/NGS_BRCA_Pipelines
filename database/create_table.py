...
cur.execute('create table if not exists mutations(GENE varchar(100), CHR varchar(100), POSITION varchar(100), '
            'TYPE varchar(100), REF varchar(1000), ALT varchar(1000), HGVS varchar(1000) primary key, '
            'RS_DBSNP varchar(100), RS_1000GENOMES varchar(100), CLIDN_CLINVAR varchar(1000), '
            ...
            'PMID_COSMIC varchar(100), REFERENCE1_UTAHDB varchar(100), REFERENCE2_UTAHDB varchar(100), '
